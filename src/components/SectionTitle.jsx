...
const SectionTitle = ({ subtitulo, tituloPrincipal, palabraResaltada }) => {
  return (
    <div className="flex flex-col mb-6 space-y-2">
      <h3 className="text-2xl md:text-4xl font-black uppercase tracking-tighter leading-none text-foreground">
        {tituloPrincipal}{" "}
        <span className="text-green-500">{palabraResaltada}</span>
      </h3>
